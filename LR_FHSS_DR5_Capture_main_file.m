...
Clay_input=16.86; %min 8.8 max 23.6 mean 16.86
VWC_input=0.119;
% VWC=0.05:0.05:0.3;
Depth=0.35;
% Depth=0.2:0.05:0.6;
...
%% Number of fragments
fragment_duration = 102.4/1000; %102.4 ms
...
% hold on
% h(2)=plot(Distance/1e3,PS_DR8/MonteCarlo,'b*');
% h(3)=plot(Distance/1e3,PS_DR8_Capture/MonteCarlo,'ro-');
% hold off
% grid on
...
figure
h(1)=plot(Distance/1000,PA_S,'b-');
hold on
h(2)=plot(Distance/1000,(PS_DR8/MonteCarlo),'b*');
hold on
h(3)=plot(Distance/1000,(PS_DR8_Capture/MonteCarlo).*P_snr(:,1)','ro-');
hold on
...
legend('DR5 analytical','DR5 Simulated', 'DR5 Capture effect','Psnr', Location='southeast');
toc

% figure
% PDR_Capture=PS_DR8_Capture/MonteCarlo;
% EPP_Capture=EPP(ToA_DR8(1),PDR_Capture);
